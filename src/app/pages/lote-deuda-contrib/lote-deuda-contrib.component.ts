...
@Component({
  selector: 'app-lote-deuda-contrib',
  templateUrl: './lote-deuda-contrib.component.html',
  styleUrls: ['./lote-deuda-contrib.component.scss']
})
export class LoteDeudaContribComponent implements OnInit {
